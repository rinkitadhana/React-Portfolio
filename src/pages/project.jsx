    ...
    return ( 
        ...
        <div>
            <div className=" flex md:flex-row flex-col justify-center gap-12 ">
                <div className=" flex flex-col items-center  md:w-1/5 mx-10 md:mx-0 md:h-[50vh] h-[48vh] border-gray-100 border shadow-lg hover:translate-y-1">
                ...
                <div className=" flex flex-col items-center md:w-1/5 mx-10 md:mx-0 md:h-[50vh] h-[48vh] border border-gray-100 shadow-lg hover:translate-y-1">
