  ...
  return (
    ...
    >
      <div className="md:px-6 px-3 mt-7">
        ...
        <div className=" mt-3 flex flex-wrap gap-1.5 dark:text-white text-gray-700">
          <div className=" flex flex-row gap-1 rounded-md text-lg justify-center items-center font-medium w-fit px-2  dark:bg-white/30 shadow shadow-gray-200 border-2 border-gray-200 dark:border-white/20 dark:shadow-none  hover:bg-gray-200 dark:hover:bg-white/20 cursor-pointer transition-all">
            <RiHtml5Fill /> HTML
          </div>
