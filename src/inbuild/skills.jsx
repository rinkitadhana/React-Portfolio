    ...
    <>
      <div className="px-6 mt-3">
        ...
        <div className=" mt-3 flex flex-wrap gap-1.5">
          <div className=" flex flex-row gap-1 rounded-md text-lg justify-center items-center font-medium w-fit px-2  dark:bg-white/30 bg-black/10 text-black dark:text-white cursor-pointer">
            <RiHtml5Fill /> HTML
          </div>
          <div className=" flex flex-row gap-1  rounded-md text-lg justify-center items-center font-medium w-fit px-2  dark:bg-white/30 bg-black/10 text-black dark:text-white cursor-pointer">
            <FaCss3Alt /> CSS
