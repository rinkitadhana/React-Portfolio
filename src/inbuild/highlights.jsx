        ...
        <div>
          <div className=" border-b-2 dark:border-white/30">
            <div className=" py-4 text-center  md:text-start">
              ...
              <span className=" font-bold text-gray-500 ">July 9, 2024</span>.
          ...
          <div className=" border-b-2 dark:border-white/30">
            <div className=" py-4 text-center  md:text-start">
              I created my{" "}
              <span className=" font-bold text-gray-500 ">first website</span>{" "}
              during my first-ever hackathon, held at{" "}
              <span className=" font-bold text-gray-500 ">MSIT, Delhi</span>,
              using only{" "}
              <span className=" font-bold text-gray-500 ">
          ...
          <div className=" border-b-2 dark:border-white/30">
            <div className=" py-4 text-center  md:text-start">
              ...
              <span className=" font-bold text-gray-500 ">Java</span> in my
              first year, with no prior knowledge of programming at all. Java
              quickly became my{" "}
              <span className=" font-bold text-gray-500 ">
                first love {":)"}
              </span>{" "}
              ...
              he's the <span className=" font-bold text-gray-500 ">GOAT</span>{" "}
