...
const Summary = () => {
  ...
  return (
    <div className=" md:mt-6 mt-4 md:text-justify text-start  ">
      ...
      section, I primarily work with React and Tailwind for the frontend, and
      Express and MongoDB for the backend. I have created many cool projects
      with these technologies, which you can view in the "
